        ...
        {isLoading ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {myRecipes.map((recipe) => (
              ...
              >
                {recipe.image_url ? (
                  <div className="bg-gray-200 dark:bg-gray-800 overflow-hidden flex items-center justify-center p-2" style={{ height: '280px' }}>
                    <img 
                  ...
                  <div className="bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/30 flex items-center justify-center" style={{ height: '280px' }}>
            ...
            {selectedRecipe && (
              <div className="space-y-6 py-4">
                ...
                {selectedRecipe.image_url && (
                  <div className="w-full rounded-xl overflow-hidden border-2 border-[rgb(var(--ios-border))] bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4" style={{ height: '400px' }}>
                    <img 
